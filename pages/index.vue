<template>
    <div class="container mx-auto px-6 py-4">
        ...
        <footer
            class="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4 mt-10 text-gray-500">
            <aside class="grid-flow-col items-center">
                ...
                <p>{{ data.labels.contact }}: <a href="mailto:marceloxp@gmail.com"
                        class="text-blue-500">marceloxp@gmail.com</a>
                </p>
            </aside>
            <nav class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <NuxtLink v-if="lang === 'en'" to="/pt" class="text-xl">🇧🇷</NuxtLink>
                <NuxtLink v-if="lang === 'pt'" to="/" class="text-xl">🇺🇸</NuxtLink>
            </nav>
